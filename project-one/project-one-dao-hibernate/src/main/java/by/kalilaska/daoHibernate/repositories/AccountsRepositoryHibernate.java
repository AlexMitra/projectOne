...
public class AccountsRepositoryHibernate implements AccountsRepository {
	...
	public void insertAccount(String login, String email, String password) {
		...
		List<RoleEntityHibernate> roles = new ArrayList<RoleEntityHibernate>();
	...
	public AccountEntityHibernate getAccountByLogin(String login) {
		TypedQuery<AccountEntityHibernate> query = manager.createNamedQuery("getAccountByLogin",
				AccountEntityHibernate.class);
	...
	public AccountEntityHibernate getAccountByEmail(String email) {
		TypedQuery<AccountEntityHibernate> query = manager.createNamedQuery("getAccountByEmail",
				AccountEntityHibernate.class);
	...
	public List<AccountEntityHibernate> getAccountsByLoginAndEmail(String login, String email) {
		TypedQuery<AccountEntityHibernate> query = manager.createNamedQuery("getAccountsByLoginAndEmail",
				AccountEntityHibernate.class);
		query.setParameter("login", login);
		query.setParameter("email", email);
	...
	@Override
	public List<RoleEntityHibernate> getAccountRoleByAccountId(long id) {
	...
	public List<AccountEntityHibernate> getAllAccounts() {
		TypedQuery<AccountEntityHibernate> query = manager.createNamedQuery("getAllAccounts",
				AccountEntityHibernate.class);
		List<AccountEntityHibernate> accountEntityList;
		try {
			accountEntityList = query.getResultList();
