...
public interface AccountService {
	...
	List<AccountBean> getSelectedLoginAndRoleAccounts(String accountLoginPart, List<RoleEntityHibernate> roleList);

	List<AccountBean> getSelectedEmailAndRoleAccounts(String accountEmailPArt, List<RoleEntityHibernate> roleList);
